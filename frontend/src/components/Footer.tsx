    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              <span className="text-white font-bold text-2xl">Auto</span>
              <span className="bg-carwash-orange text-white px-2 py-1 rounded-md font-bold">BOX</span>
              <span className="text-white font-bold text-2xl">Car</span>
            </div>
            <p className="text-gray-400 mb-6">
              Seu carro merece o melhor tratamento, e nós garantimos isso com qualidade e agilidade.
            </p>
            <p className="text-gray-400">
              © {new Date().getFullYear()} Auto Box Car.<br/>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <div className="flex">
                <Input 
                  ...
                  type="email"
                />
                <Button type="submit" className="rounded-l-none bg-carwash-orange hover:bg-orange-600">
                  Enviar
                </Button>
              </div>
            </form>
        ...
        <div className="pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>Desenvolvido com ♥ por Auto Box Car - Todos os direitos reservados</p>
        </div>
      </div>
    </footer>
  );
